...
class Hoteis(Resource):
    def get(self):   
        connection = sqlite3.connect('banco.db') # aula 61
        cursor = connection.cursor()

        dados = path_params.parse_args() # aula 59
        ...
        # Aula 63 Interando sobre resultado de consulta ao banco   
